...
test("calls method scheduledRecipeDeleted on click with correct parameter", () => {
    ...
    // Act
    userEvent.click(container.getElementsByClassName("ingredientComponentListItem__editButton")[0])
...
test("calls method scheduledRecipeDeleted on click with correct parameter", () => {
    ...
    // Act
    userEvent.click(container.getElementsByClassName("ingredientComponentListItem__deleteButton")[0])
